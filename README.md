...
The latest presentation of this project was at the [Festival of Genomics and Biodata 2026](https://festivalofgenomics.com/london/) in London, UK, on January 28th 2026.  
![FOG EU 2026 Talk](images/FOG_2026_talk.png)  
This project has been also presented at the [BioTechX Europe 2025](https://www.terrapinn.com/conference/biotechx/index.stm) conference in Basel, Switzerland, on October 7th 2025. ![Gromacs Smolagent Landing Image](images/BioTechX_talk_banner.png)   
...
[What is Smolagents?](#what-is-smolagents)  
...
&nbsp;&nbsp;&nbsp;&nbsp;[Small Language Model (SLM) used](#small-language-model-slm-used)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Local Models through the HF's Transformers API](#local-models-through-the-hfs-transformers-api)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Local Models through Ollama](#local-models-through-ollama)  
&nbsp;&nbsp;&nbsp;&nbsp;[CLI Execution](#cli-execution)  
&nbsp;&nbsp;&nbsp;&nbsp;[Agent Inspectability](#agent-inspectability)  
[UI](#ui)  
#### What is Gromacs?
